...
?>
<div class="list-one experimental-block-post-list-tab-content-wrapper">
    <div class="experimental-block-post-list-tab-content active">
        <?php foreach ($getPosts as $post) : ?>
            <article>
                <div class="list-item-wrapper clear">
                    ...
                    <?php endif; ?>
                    <div class="entry-container clear" style="width: <?php echo $attributes['showThumbnail'] ? '50%' : '100%';?>;">
