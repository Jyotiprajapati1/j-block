...
/**
 * The save function describes the structure of your block in the context of
 * the front-end. This represents what the block will render when saved.
 *
...
export default function Save({ attributes }) {
  ...
  const telegramIcon = (
    <svg
      ...
      fill={iconColor}
    >
      <path d="M23.18 2.82a1.5 1.5 0 0 0-1.62-.23L1.87 10.58c-.52.23-.86.76-.87 1.34s.34 1.1.86 1.34l4.4 2.02c.1.04.2.06.3.06.34 0 .67-.15.9-.41l2.89-3.21 3.9 3.7c.42.4 1.1.44 1.57.09l5.28-4.03c.18-.14.32-.32.42-.52.37-.77.27-1.67-.26-2.31l-4.06-4.95L23.18 2.82zm-6.25 7.47l-1.42 1.08-3.58-3.4L17.1 6l-2.17 4.29zM5.67 13.24l-.95-.44 13.46-6.47L10.9 10.9l-5.23 2.34zM12.67 18l-.92.7-1.95-1.9 2.55-2.84 3.57 3.38L12.67 18z" />
    </svg>
  );
  ...
  return (
    <div {...blockProps}>
      <div className="wp-block-social-share">
        {facebook && (
          <a
            className="wp-block-facebook-share"
            data-action="facebook-share"
            style={linkStyle}
          >
            {facebookIcon}
            {enablelabel === true && __(" Facebook", "experimental-block")}
          </a>
        )}
        {twitter && (
          <a
            className="wp-block-twitter-share"
            data-action="twitter-share"
            style={linkStyle}
          >
            {twitterIcon}
            {enablelabel === true && __(" Twitter", "experimental-block")}
          </a>
        )}
        {gmail && (
          <a
            className="wp-block-gmail-share"
            data-action="gmail-share"
            style={linkStyle}
          >
            {gmailIcon}
            {enablelabel === true && __(" Gmail", "experimental-block")}
          </a>
        )}
        {whatsApp && (
          <a
            className="wp-block-whatsApp-share"
            data-action="whatsApp-share"
            style={linkStyle}
          >
            {whatsAppIcon}
            {enablelabel === true && __(" WhatsApp", "experimental-block")}
          </a>
        )}
        {linkedIn && (
          <a
            className="wp-block-linkedIn-share"
            data-action="linkedIn-share"
            style={linkStyle}
          >
            {linkedInIcon}
            {enablelabel === true && __(" LinkedIn", "experimental-block")}
          </a>
        )}
        {reddit && (
          <a
            className="wp-block-reddit-share"
            data-action="reddit-share"
            style={linkStyle}
          >
            {redditIcon}
            {enablelabel === true && __(" Reddit", "experimental-block")}
          </a>
        )}
        {tumblr && (
          <a
            className="wp-block-tumblr-share"
            data-action="tumblr-share"
            style={linkStyle}
          >
            {tumblrIcon}
            {enablelabel === true && __(" Tumblr", "experimental-block")}
          </a>
        )}
        {diigo && (
          <a
            className="wp-block-diigo-share"
            data-action="diigo-share"
            style={linkStyle}
          >
            {diigoIcon}
            {enablelabel === true && __(" Diigo", "experimental-block")}
          </a>
        )}
        {pinterest && (
          <a
            className="wp-block-pinterest-share"
            data-action="pinterest-share"
            style={linkStyle}
          >
            {pinterestIcon}
            {enablelabel === true && __(" Pinterest", "experimental-block")}
          </a>
        )}
        {viber && (
          <a
            className="wp-block-viber-share"
            data-action="viber-share"
            style={linkStyle}
          >
            {viberIcon}
            {enablelabel === true && __(" Viber", "experimental-block")}
          </a>
        )}
        {snapchat && (
          <a
            className="wp-block-snapchat-share"
            data-action="snapchat-share"
            style={linkStyle}
          >
            {snapchatIcon}
            {enablelabel === true && __(" Snapchat", "experimental-block")}
          </a>
        )}
      </div>
    </div>
